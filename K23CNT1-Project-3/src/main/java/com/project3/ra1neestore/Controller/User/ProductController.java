...
public class ProductController {
    ...
    private final com.project3.ra1neestore.Repository.ReviewRepository reviewRepository;
    private final com.project3.ra1neestore.Repository.UserRepository userRepository;
    ...
    public String productDetail(@org.springframework.web.bind.annotation.PathVariable Long id, Model model) {
        ...
        List<com.project3.ra1neestore.Entity.Review> reviews = reviewRepository.findByProductIdOrderByCreatedAtDesc(id);
        ...
        model.addAttribute("newReview", new com.project3.ra1neestore.Entity.Review());
    ...
    public String addReview(@org.springframework.web.bind.annotation.PathVariable("productId") Long productId,
            @org.springframework.web.bind.annotation.ModelAttribute("newReview") com.project3.ra1neestore.Entity.Review review,
        ...
        com.project3.ra1neestore.Entity.User user = userRepository.findByUsername(principal.getName())
